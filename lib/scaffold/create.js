...
var BASE_PACKAGE = {
  description: 'A full LitecoinZ node build with Bitcore',
  repository: 'https://github.com/user/project',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-litecoinz': 'LitecoinZ/bitcore-lib-litecoinz',
    'bitcore-node-litecoinz': 'LitecoinZ/bitcore-node-litecoinz'
  }
};
